...
/*!< Uncomment the following line if you need to relocate the vector table,
     else the vector table is kept at the automatic remap of boot address selected */
#define USER_VECT_TAB_ADDRESS

#if defined(USER_VECT_TAB_ADDRESS)
#define VECT_TAB_BASE_ADDRESS   OCTOSPI2_BASE     /*!< Vector Table base address field.
